...
{
    public static async Task ExtractToDirectory(this TarReader source, string destinationDirectoryName, IProgress<int> prog, Action<TarEntry, string>? preExtractHook = null, Action<TarEntry, string>? afterExtractHook = null) {
